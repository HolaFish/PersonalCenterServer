package com.fxsh.task.web.config;

import com.fxsh.task.web.shiro.BCryptCredentialsMatcher;
import com.fxsh.task.web.shiro.CommonAuthRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Autowired DefaultWebSecurityManager securityManager){
        ...
        filterMap.put("/auth/unLogin", "anon");
     ...
     */
    @Bean
    public DefaultWebSecurityManager defaultWebSecurityManager(@Autowired CommonAuthRealm userRealm){
     ...
     */
    @Bean
    public CommonAuthRealm userRealm(BCryptCredentialsMatcher cryptCredentialsMatcher){
        CommonAuthRealm commonAuthRealm = new CommonAuthRealm();
        commonAuthRealm.setCredentialsMatcher(cryptCredentialsMatcher);
        return commonAuthRealm;
    }
